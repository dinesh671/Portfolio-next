      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className=' min-h-screen '>
          ...
          <div className='text-center p-10'>
            <h2 className='text-5xl py-2 text-teal-600 font-extrabold md:text-6xl'>Dinesh Kumar</h2>
        ...
        <section>
          <div>
            <h3 className='text-3xl py-1 pt-1 dark:text-slate-100'>
              Portfolio 
            </h3>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-slate-400">
              Since the beginning of my journey as a freelance designer and
